            ...
            <div class="center">
                ...
                <div class="form-holder">
                    <form>
                        ...
                        <input type="password" v-model="loginForm.password" autocomplete="true" class="input"
                            placeholder="密码" />
                    </form>
                </div>
        ...
        <div class="signup slide-up">
            ...
            <div class="form-holder">
                <form>
                    ...
                    <input type="password" v-model="signupForm.password" autocomplete="true" class="input"
                        placeholder="密码" />
                </form>
            </div>
...
.form-structor {
    background-color: var(--background-origin,#222);
    border-radius: 4px;
    max-height: 550px;
    height: 100%;
    min-height: 480px;
...
.form-structor .login .center .submit-btn {
    background-color: var(--theme-color,#6b92a4);
    color: rgba(255, 255, 255, 0.9);
    border: 0;
    border-radius: 4px;
    display: block;
