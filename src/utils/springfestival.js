 ...
 function addStyles() {
     ...
     style.textContent =
       ...
       .deng-box1 { position: fixed; top: 16px; left: 10px; }
       .deng-box2 { position: fixed; top: 12px; left: 130px; }
       .deng-box3 { position: fixed; top: 12px; right: 130px; }
       .deng-box4 { top: 16px; }
       .deng {
           position: relative;
           width: 120px;
       ...
       @media (max-width: 768px) {
           ...
           .deng-box1 { left: -20px; width: fit-content; }
           .deng-box2 { left: 40px; width: fit-content; }
           .deng-box3 { right: 40px; }
