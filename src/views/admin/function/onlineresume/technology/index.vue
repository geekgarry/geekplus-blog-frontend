<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="关联的简历表id" prop="technologyName">
        <el-input
      ...
      <el-form-item label="关联的简历表id" prop="technologyScore">
        <el-input
          v-model="queryParams.technologyScore"
          placeholder="请输入关联的简历表id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="technologyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关联的简历表id" align="center" prop="technologyName" />
      <el-table-column label="关联的简历表id" align="center" prop="technologyScore" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="关联的简历表id" prop="technologyName">
          <el-input v-model="form.technologyName" placeholder="请输入关联的简历表id" />
        </el-form-item>
        <el-form-item label="关联的简历表id" prop="technologyScore">
          <el-input v-model="form.technologyScore" placeholder="请输入关联的简历表id" />
        </el-form-item>
        <el-form-item label="关联的简历表id" prop="resumeId">
